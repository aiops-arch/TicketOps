...
values
  ...
  ('U-MGR-PRATIK', 'pratik.patel', 'pbkdf2:120000:d9778cb8f2cacd1633eeb0239cd22d87:923afc6207abf49b386396850d5df74eda4166b1dfe40a1a97bc87a8a4b6023c', 'Pratik Patel', 'Outlet Manager', 'manager', 'aiko surat', null, true, array[]::text[], 'dashboard', array['dashboard', 'manager', 'reports']),
  ('U-MGR-HUSSAIN', 'hussain.sheikh', 'pbkdf2:120000:5542a0b2e59554516ae58e01deb207ac:52f76c3bf884aac40e9bbeae6bcd36d753cf1d38a15ae1ff45c3549ad24a23db', 'Hussain Sheikh', 'Outlet Manager', 'manager', 'Capiche', null, true, array[]::text[], 'dashboard', array['dashboard', 'manager', 'reports']),
